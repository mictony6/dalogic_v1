...
export class StoryLevelSelection2 extends Scene{
  ...
  onInitialize(engine: Engine): void {
    ...
    this.backgroundImage = new Actor({width:Resources.StoryScene2.width, height:Resources.StoryScene2.height})
    this.backgroundImage.graphics.use(Resources.StoryScene2.toSprite());
  ...
  onActivate(context: SceneActivationContext<unknown>): void {
    ...
    this.gameMode.textContent = 'CAS Park';
    wrapper.appendChild(this.gameMode);
